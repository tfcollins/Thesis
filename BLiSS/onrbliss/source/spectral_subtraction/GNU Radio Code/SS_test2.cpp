...
{
/*
    N = 10000; //size of signals I HAVE NO IDEAE WHAT TO USE AS A SIZE?
    double Alpha=10, Beta=.2;
    double *RecSigt[2], *RecSigf[2] IntSig[N];
    
    FILE *data = fopen("data.txt", "r")
    
    RecSigt = malloc(2 * N * sizeof(double));
    RecSigf = malloc(2 * N * sizeof(double));
